...
class weatherPlugin(Plugin):
    localizations = {"weatherForecast": 
                        {"search":{
                            0:{"de-DE": u"Einen Moment Geduld bitte...", "en-US": u"搜索天氣資訊中..."},
                            1:{"de-DE": u"Ich suche nach der Vorhersage ...", "en-US": u"正在搜尋天氣資訊，請稍後..."},
                            2:{"de-DE": u"Einen Moment bitte ...", "en-US": u"稍等一下..."},
                            3:{"de-DE": u"Ich suche nach Wetterdaten...", "en-US": u"搜尋當前區域的天氣狀況..."},
                            }, 
                        "forecast":{
                            "DAILY": {
                                0:{"de-DE": u"Hier ist die Vorhersage für {0}, {1}", "en-US": u"天氣於 {0}, {1}"},
                                1:{"de-DE": u"Hier ist die Wetterprognose für {0}, {1}", "en-US": u" {0}, {1} 的天氣預報"},
                                2:{"de-DE": u"Ich habe folgende Vorhersage für {0}, {1} gefunden", "en-US": u"天氣預報如下 {0}, {1}"},
                                },
                            "HOURLY": {
                                0:{"de-DE": u"Hier ist die heutige Vorhersage für {0}, {1}", "en-US": u"今天天氣於 {0}, {1}"},
                                1:{"de-DE": u"Hier ist die Wetterprognose von heute für {0}, {1}", "en-US": u"這是今天的天氣預報於 {0}, {1}"},
                                2:{"de-DE": u"Ich habe folgende Tagesprognose für {0}, {1} gefunden", "en-US": u" {0}, {1} 的天氣預報"},
                                }
                            },
                        "failure": {
    ...
    @register("en-US", u"(.*天氣.*)|(.*天氣預報.*)")
    def weatherForecastLookUp(self, speech, language):
        speech = speech.replace(u".","")
        viewType ="DAILY"
        if (speech.count(u"今天") > 0 or speech.count(u"當前") > 0 or speech.count(u"目前") > 0) and language=="en-US":
            viewType = "HOURLY"
